...
function openSettings() {
    function submitSettings(data) {
        ...
        let manualMapping = [], learningMapping = [], preTrainedMapping = [];
...
function getScreenPosition(gridPosition) {
    ...
    screenPosition = sub(screenPosition, [truckNorth.offsetWidth / 2, truckNorth.offsetHeight / 2]);
...
function truckAnimate(startPosition, endPosition, duration = 1000, truck = truckNorth, once) {
...
truckNorth.style.display = truckEast.style.display = truckSouth.style.display = truckWest.style.display = 'none';
