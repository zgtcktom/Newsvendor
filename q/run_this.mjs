...
// class NDArray {
//     offset;
//     constructor(shape, buffer, strides, offset) {
//         this.shape = shape;
//         this.data = buffer;
//         this.itemsize = 1;
//         this.strides = strides ?? get_strides(this.shape, this.itemsize);
//         this.offset = offset;
//     }
//     getitem(index) {
...
//         let a_v = isiterable(a), lower_v = isiterable(lower), upper_v = isiterable(upper);
//         if (a_v) {
