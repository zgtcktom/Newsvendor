...
let data1 = [
  13, 10, 8, 11, 11, 6, 17, 16, 15, 17, 14, 14, 14, 12, 16, 20, 18, 17, 20, 15,
];
let data2 = [
  9, 13, 6, 13, 7, 12, 11, 8, 9, 10, 9, 10, 4, 7, 12, 15, 4, 5, 9, 10, 7, 8, 9,
  5, 18, 13, 12, 11, 7, 11, 10, 8, 8, 10, 10, 9, 7, 7, 10, 10, 10, 8, 9, 14, 9,
  7, 8, 9, 10, 7, 11, 7, 7, 10, 12, 14, 13, 9, 6, 13, 14, 12, 5, 14, 9, 4, 13,
  7, 6, 7, 8, 11, 9, 7, 14, 16, 8, 7, 8, 9, 15, 9, 12, 7, 10, 10, 7, 6, 8, 12,
  7, 5, 3, 6, 14, 16, 12, 4, 11, 15, 8, 9, 4, 7, 9, 16, 13, 11, 10, 12, 7, 8,
  10, 15, 12, 6, 15, 10, 11, 11, 9, 9, 9, 14, 7, 7, 14, 10, 13, 11, 15, 11, 13,
  13, 9, 9, 13, 7, 14, 9, 8, 6, 12, 11, 14, 7, 13, 17, 11, 15, 12, 9, 17, 7, 6,
  12, 12, 10, 11, 7, 10, 9, 9, 8, 12, 13, 10,
];
data1.sort((a, b) => a - b);
data2.sort((a, b) => a - b);
