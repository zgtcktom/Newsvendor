...
export class RL_brain_base {
  ...
  simulation(S, R, a, episode, LOST) {
    ...
    if (
      ...
      demand = Math.max(
        Math.round(random.normal(this.MEAN1, Math.sqrt(this.VAR1))),
        0
      );
    } else {
      demand = Math.max(
        Math.round(random.normal(this.MEAN2, Math.sqrt(this.VAR2))),
        0
      );
    }
  ...
  *rliter() {
    ...
    for (let i = 0; i < this.SIMULATION_TIME; i++) {
      ...
      for (let episode = 0; episode < this.MAX_EPISODES; episode++) {
        ...
        [S_, IP_, IL_, R, lost, demand] = this.simulation(
          S[episode],
          R,
          a,
          episode,
        ...
        if (
          ...
          if (episode <= this.LEAD_TIME - 1) {
            ...
            q_target =
              ...
              GAMMA *
                Math.max(
                  ...getitem(q_table_1, [getitem(IP, [-(this.LEAD_TIME - 1)])])
                );
            setitem(
              q_table_1,
          ...
          if (episode <= this.LEAD_TIME - 1) {
            ...
            q_target =
              ...
              GAMMA *
                Math.max(
                  ...getitem(q_table_2, [getitem(IP, [-(this.LEAD_TIME - 1)])])
                );
            setitem(
              q_table_2,
              [getitem(IP, [-this.LEAD_TIME]), getitem(a, [-this.LEAD_TIME])],
